...
export default function LoginPage() {
    ...
    const [message, setMessage] = useState(null); // Changed to null/object for cleaner logic
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // 2. Success!
            // Supabase automatically saves the session token in LocalStorage.
    ...
    // Optional: Helper for Social Login (Requires Supabase Dashboard Config)
