    ...
    <div className="antialiased h-[100dvh] w-full overflow-hidden bg-[#FDFBF7] flex justify-center relative font-sans">
      ...
      <div className="relative z-10 w-full max-w-md h-full flex flex-col px-6 py-6 md:py-10">
        ...
        <div className="w-full flex-shrink-0 flex flex-col space-y-4 pb-4 md:pb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          {/* LINK TO MAIN APP (For now, we link to Home) */}
          <Link to="/home" className="group relative flex w-full justify-center items-center rounded-2xl bg-brand-dark px-6 py-4 text-lg font-bold text-white shadow-lg shadow-brand-dark/30 transition-all duration-300 hover:shadow-brand-dark/50 hover:-translate-y-1 active:scale-95">
            Let's get started
